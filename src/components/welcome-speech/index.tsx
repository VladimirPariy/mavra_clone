  ...
  return (
    <div className='flex py-[70px] flex-wrap justify-center'>
      ...
      <div className='max-w-[585px] px-[50px] py-[35px] text-center'>
        ...
        <h2 className='pb-5 text-4xl font-semibold text-[#402813]'>Привет! Я – MAVRA PIZZA!</h2>
        <div className='text-sm flex flex-col gap-2.5 leading-7'>
          <p>
            Создаю для тебя самую волшебную и вкусную пиццу Запорожья. Авторские рецепты, фирменные
            ингредиенты и немного магии.
          </p>
